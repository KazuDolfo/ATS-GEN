...
// [Módulo II] ATS_Tokenizer - Tokenización y mapeo de alias
        ...
        const ATS_SummaryAnalyzer = {
            ...
            analyze: function(summaryText, cleanTextJob, hardSkillsTaxonomy) {
                ...
                const actionRegex = /implemente|implementé|desarrolle|desarrollé|disene|diseñe|optimice|optimicé|cree|créé|integre|integré|automatice|automaticé|lidere|lideré|mejore|mejoré|reduje|reducir|reduciendo|aumentando|construi|construí|ejecute|ejecuté|migre|migré|reemplace|reemplacé|coordine|coordiné|analice|analicé|supervise|supervisé|compatibilice|compatibilicé|elabore|elaboré|mitigue|mitigué|planifique|planifiqué/i;
                const quantityRegex = /\b\d+(?:[.,]\d+)?\s*(?:%|m3|m2|segundos?|minutos?|horas?|dias?|semanas?|usuarios?|clientes?|registros?|errores?|consultas?|solicitudes?|transacciones?|interferencias?|sobrecostos?|desperdicio)?\b/i;
                const impactRegex = /tiempos|cobertura|latencia|usuarios|clientes|ventas|costos|ahorro|procesos|eficiencia|rendimiento|fraude|minutos|segundos|horas|dias|semanas|solicitudes|peticiones|transacciones|registros|errores|despliegues|consultas|disponibilidad|interferencias|sobrecostos|desperdicio|vaciado|avance|presupuesto|desviacion|seguridad|calidad|merma|fallas|ensayos|probetas|metrados|valorizaciones|rendimientos|concreto|entrega/i;
